...
dict['number_stations_threshold_for_template'],dict['mad_threshold'],dict['too_close_detections_to_remain'] = 4,9,6
dict['radius'] = {'nx':1,'ny':1,'nz':1,'dx':.01,'dy':.01,'dz':1}
...
dict['log'] = 'pdf'
dict['minimum_cc'] = .3
dict['number_high_cc_channels_threshold'] = 4
dict['number_high_cc_stations_threshold'] = 2
dict['max_number_channels'] = 70
dict['plot'] = 0
dict['continue_previous_experiment'] = 0
dict['max_number_channels_in_one_station'] = 1
